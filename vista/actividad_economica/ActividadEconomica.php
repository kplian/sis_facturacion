	...
	Atributos:[
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'aeco.nombre_actividad',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'aeco.estado_reg',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'aeco.codigo_actividad',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
		...
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'aeco.fecha_reg',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'aeco.usuario_ai',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'Field',
				filters:{pfiltro:'aeco.id_usuario_ai',type:'numeric'},
				id_grupo:1,
				grid:false,
				form:false
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'aeco.fecha_mod',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
